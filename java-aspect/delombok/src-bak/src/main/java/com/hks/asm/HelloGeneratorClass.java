...
public class HelloGeneratorClass implements Opcodes {
    ...
    public static byte[] generatorHelloClass() throws Exception {
        ...
        cw.visit(V1_7, ACC_PUBLIC + ACC_SUPER, "com/hks/asm/Hello", null, "java/lang/Object", null);
        ...
        }
        {
            ...
            mv.visitFrame(Opcodes.F_FULL, 8,
                    new Object[] {"com/hks/asm/Hello", Opcodes.INTEGER, "[Ljava/util/Map;",
            ...
            mv.visitLabel(l2);
            mv.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/hks/asm/Hello", Opcodes.INTEGER,
